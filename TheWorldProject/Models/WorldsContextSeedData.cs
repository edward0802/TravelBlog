...
{
    public class WorldsContextSeedData
    {
        private WorldContext _context;
        private UserManager<WorldUser> _userManager;
        private SignInManager<WorldUser> _signInManager;

        public WorldsContextSeedData(WorldContext context, UserManager<WorldUser> userManager, SignInManager<WorldUser> signInManager)
        {
            _context = context;
        ...
        public async Task EnsureSeedData()
        {
            if(await _userManager.FindByEmailAsync("sam.hasting@theworld.com") == null) 
            {
                ...
                var result = await _userManager.CreateAsync(user, "Passw@rd1234"); 
            }
